...
public class Token
{
    ...
    public static final int INTARRAY   = 8; //integer array
    public static final int FLOATARRAY = 9; //float array
    public static final int STRINGARRAY = 10; //float array
    public static final int BOOLEANARRAY = 11; //float array
